...
WITH TD learning.
so you can see, i'm not calculating Gt value from the immediates.
I'm calculating Gt from nv_hat=critic(ns)
and update in every single step which is for TD learning.

tips:
i needed to lower the ALPHA.
"""
...
for _ in range(1000):
    ...
    while not done:
        ...
        all_list.append([s,ns,a,immediate,done,v_hat,Gt,A])
